...
export default class ApiClient {
    constructor() {
         ...
         * @default /
         */
        this.basePath = '/'.replace(/\/+$/, process.env.VUE_APP_API_ENDPOINT);
        ...
        this.authentications = {
            'Bearer': { type: 'apiKey', apiKey: JSON.parse(window.localStorage.getItem('user_info') || '{}').token || '', 'in': 'header', name: 'Authorization', apiKeyPrefix: 'Bearer' }
        }
